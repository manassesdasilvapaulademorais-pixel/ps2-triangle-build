...
int main(void) {
    ...
    set_qword(q, 0xFF0000FF, GS_REG_RGBAQ); 
    q++;
    set_qword(q,
        ((u64)(GS_XY_OFFSET + PX(320)) & 0xFFFF) |
        (((u64)(GS_XY_OFFSET + PX(100)) & 0xFFFF) << 16) |
        ((u64)0 << 32),
        GS_REG_XYZ2);
    q++;

    set_qword(q, 0x00FF00FF, GS_REG_RGBAQ); 
    q++;
    set_qword(q,
        ((u64)(GS_XY_OFFSET + PX(120)) & 0xFFFF) |
        (((u64)(GS_XY_OFFSET + PX(350)) & 0xFFFF) << 16) |
        ((u64)0 << 32),
        GS_REG_XYZ2);
    q++;

    set_qword(q, 0x0000FFFF, GS_REG_RGBAQ); 
    q++;
    set_qword(q,
        ((u64)(GS_XY_OFFSET + PX(520)) & 0xFFFF) |
        (((u64)(GS_XY_OFFSET + PX(350)) & 0xFFFF) << 16) |
        ((u64)0 << 32),
        GS_REG_XYZ2);
    q++;
